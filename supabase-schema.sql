-- Supabase Database Schema for Mood Journal App
-- Run this SQL in your Supabase SQL Editor

-- Note: uuid-ossp extension is usually already enabled in Supabase
-- If you get an error, you can skip this line as the extension is likely already available
...
CREATE TABLE IF NOT EXISTS public.entries (
    ...
    date DATE NOT NULL,
    mood TEXT,
    moods JSONB, -- Array of mood objects
    text TEXT,
    ai_response TEXT,
    created_at TIMESTAMPTZ DEFAULT NOW(),
    updated_at TIMESTAMPTZ DEFAULT NOW(),
...
CREATE TABLE IF NOT EXISTS public.email_logs (
    ...
    body TEXT,
    type TEXT NOT NULL, -- password_reset, welcome, etc.
